  ...
  <tbody>
        @foreach ($mujibHistorydash as $item)
            <tr>
                ...
                <td><img width="200" src="{{asset('frontEnd/uploads/mijib_history')}}/{{$item->photo}}" alt="No Photo" srcset=""></td>
                <td><a class="btn btn-danger" href="{{url('/delete_mujibHistorydash/delete')}}/{{$item->id}}">Delete</a></td>
